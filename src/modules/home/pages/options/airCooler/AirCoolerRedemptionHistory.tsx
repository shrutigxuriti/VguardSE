    ...
    const renderItem = ({ item }) => (
        <View style={[styles.item]}>
            ...
            <View style={styles.detail}>
                ...
                <Text style={[styles.smalltext]}>{t('strings:stars')}: {item.points}</Text>
                <Text style={[styles.smalltext]}>{t('strings:material_code')}: {item.materialCode}</Text>
            </View>
...
export default AirCoolerRedemptionHistory;
